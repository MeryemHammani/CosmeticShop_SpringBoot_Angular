...
export class SharedServiceService {
  ...
  public getErrorMessage(fieldName: string, error: ValidationErrors) {
    ...
    else if (error['pattern'] && !fieldName.includes("Mot de passe")) return "Veuillez entrer un(e) " + fieldName + " valide";
    else if (error['pattern'] && fieldName.includes("Mot de passe")) return "Mot de passe invalide. Le mot de passe doit contenir au moins une lettre majuscule, une lettre minuscule, un chiffre et un caractère spécial.";
